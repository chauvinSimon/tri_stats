...
- **2) Events consistency**:
  ...
  - Instead, `wm_percent` should be estimated considering events with **similar swim conditions** as those for `wm_percent_w_fast`.
    - Idea #1: Only consider events with the **same format** (olympic) and **event-category** (WTCS).
      - This leads to a **slightly lower estimate** (`wm_percent = 8.1% ± 2.4%`), resulting in an **`improve_percent` closer to 4.8%**.
...
|:------:|:--------------------------------------------------------------------------------------------------------------:|:------------------------------------:|:-----------------:|:----------:|:----------------:|
|  2024  | [Cagliari](https://www.triathlon.org/events/event/2024_world_triathlon_championship_series_cagliari) ( :it: )  |                 2.3%                 |     **4.7%**      |  olympic   |       WTCS       |
|  2021  |   [Edmonton](https://www.triathlon.org/events/event/2021_world_triathlon_grand_final_edmonton) ( :canada: )    |                 2.4%                 |     **4.6%**      |  olympic   |       WTCS       |
|  2022  | [Yokohama](https://www.triathlon.org/events/event/2022_world_triathlon_championship_series_yokohama) ( :jp: )  |                 2.9%                 |     **4.2%**      |  olympic   |       WTCS       |
|  2015  |      [Stockholm](https://www.triathlon.org/events/event/2015_itu_world_triathlon_stockholm) ( :sweden: )       |                 3.3%                 |     **3.8%**      |  olympic   |       WTCS       |
|  2024  | [Yokohama](https://www.triathlon.org/events/event/2023_world_triathlon_championship_series_yokohama1) ( :jp: ) |                 3.5%                 |     **3.7%**      |  olympic   |       WTCS       |
...
- A recent exception was [Cassandre Beaugrand ( :fr: ) holding a watch in Gagliari 2024 ( :it: )](https://youtu.be/vFV-kB8727I?t=189). Also at the [Olympics in Paris](https://www.francetvinfo.fr/les-jeux-olympiques/triathlon/triathlon-aux-jo-de-paris-2024-cassandre-beaugrand-de-princesse-a-reine-du-triathlon_6698148.html). _Maybe to pace her 10k?_
- Another example is Hayden Wilde ( :new_zealand: ), [running at the Paris Olympics with some pacing device](https://www.triathlon.org/uploads/hrgalleries/191104/awag1132_paris2024__medium.jpg) (discussion [here](https://the5krunner.com/2024/08/01/alex-yee-paris-gold-with-coros-dura-plus-what-was-haydn-wilde-looking-at-during-the-run/)), and at [Gagliari 2023 ( :it: )](https://triathlon.org/results/result/2023_world_triathlon_championship_series_cagliari/586471) where [he did not wear any watch for swimming](https://triathlon-uploads.imgix.net/webgalleries/174957/tzaf5501.jpg?w=1140&auto=format), but [had one for running](https://triathlon-uploads.imgix.net/webgalleries/174957/tomz0840.jpg?w=1140&auto=format) (maybe attached with [an elastic band?](https://www.youtube.com/watch?v=eyliQoQskww), which [he stopped at the finish line](https://triathlon-uploads.imgix.net/webgalleries/174957/tomz0987.jpg?w=1140&auto=format).
